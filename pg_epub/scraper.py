...
from .config import ARTICLES_INDEX_URL, BASE_URL, REQUEST_DELAY, REQUEST_TIMEOUT, USER_AGENT
...
class Scraper:
    ...
    def fetch_binary(self, url: str, silent: bool = False) -> bytes | None:
    ...
    def parse_date_string(self, date_str: str) -> tuple[str | None, str]:
        """
    ...
    def extract_date_from_essay(self, soup: BeautifulSoup) -> tuple[str | None, str]:
        """
    ...
    def fetch_essay_content(self, url: str) -> tuple[str | None, str | None, str | None]:
        """
